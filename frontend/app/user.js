...
function(
  ...
  user.hasAccessToSubdivision = function(subdivisionId)
  {
    ...
    {
      var subdivision = require('app/data/orgUnits').getByTypeAndId('subdivision', subdivisionId);
  ...
  {
    var orgUnits = require('app/data/orgUnits');
    var divisionId = null;
    ...
    switch (user.data.orgUnitType)
    {
      ...
      case 'subdivision':
        var subdivision = orgUnits.getByTypeAndId('subdivision', user.data.orgUnitId);
    ...
    return orgUnits.getByTypeAndId('division', divisionId) || null;
  };
  ...
  user.getSubdivision = function()
  {
    ...
    return require('app/data/orgUnits').getByTypeAndId('subdivision', user.data.orgUnitId);
  };
