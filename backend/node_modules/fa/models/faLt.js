...
exports.setUp = (app, mongoose) =>
{
  ...
  ltSchema.statics.STAGES = STAGES;
  ltSchema.statics.SEARCH_PROPS = ['assetName', 'buyerName'];
  ltSchema.statics.USER_PROPS = ['createdBy', 'owner', 'applicant', 'committee'];
  ...
  ltSchema.pre('save', function(next)
  {
    ...
    collectUsers(this, ltSchema.statics.USER_PROPS);
  ...
  ltSchema.methods.canEdit = function(user)
  {
    const privileges = user.privileges || [];

    if (privileges.includes('FA:MANAGE') || privileges.includes('FA:LT:MANAGE'))
    {
      return true;
    }
