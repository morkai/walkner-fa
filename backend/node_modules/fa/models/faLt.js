...
exports.setUp = (app, mongoose) =>
{
  ...
  schema.pre('save', function(next)
  {
    ...
    this.users = Array.from(collectUsers(this, schema.statics.USER_PROPS));
  ...
  {
    const assets = this.assets.length ? this.assets : [{no: '', transactionType: ''}];

    return {
      reqTplId: `lt.${this.kind}`,
      valueColumns: assets.length,
      protocolNo: {
        type: 'string',
        value: assets.map(() => this.protocolNo)
      },
      documentNo: {
        type: 'string',
        value: assets.map(() => this.documentNo)
      },
      protocolDate: {
        type: 'string',
        value: assets.map(() => this.protocolDate ? moment.utc(this.protocolDate).format('YYYY-MM-DD') : '')
      },
      documentDate: {
        type: 'string',
        value: assets.map(() => this.documentDate ? moment.utc(this.documentDate).format('YYYY-MM-DD') : '')
      },
      inventoryNo: {
        type: 'string',
        value: assets.map(() => this.inventoryNo)
      },
      assetName: {
        type: 'string',
        value: assets.map(() => this.assetName)
      },
      owner: {
        type: 'string',
        value: assets.map(() => this.owner ? this.owner.label : '')
      },
      committee: {
        type: 'string',
        value: assets.map(() => this.committee.map(u => u.label).join(', '))
      },
      applicant: {
        type: 'string',
        value: assets.map(() => this.applicant ? this.applicant.label : '')
      },
      supplier: {
        type: 'string',
        value: assets.map(() => this.supplier)
      },
      costCenter: {
        type: 'string',
        value: assets.map(() => this.costCenter)
      },
      transactionType: {
        type: 'string',
        value: assets.map(a => a.transactionType)
      },
      postingDate: {
        type: 'string',
        value: assets.map(() => this.postingDate ? moment.utc(this.postingDate).format('YYYY-MM-DD') : '')
      },
      valuationDate: {
        type: 'string',
        value: assets.map(() => this.valuationDate ? moment.utc(this.valuationDate).format('YYYY-MM-DD') : '')
      },
      assetNo: {
        type: 'string',
        value: assets.map(a => a.no)
      },
      subAssetNo: {
        type: 'string',
        value: assets.map(() => this.subAssetNo)
      },
      accountingNo: {
        type: 'string',
        value: assets.map(() => this.accountingNo)
      },
      odwNo: {
        type: 'string',
        value: assets.map(() => this.odwNo)
      },
      tplNotes: {
        type: 'string',
        value: assets.map(() => this.tplNotes)
      },
      cause: {
        type: 'string',
        value: assets.map(() => this.cause)
      },
      initialValue: {
        type: 'decimal',
        value: assets.map(() => this.initialValue)
      },
      deprecationValue: {
        type: 'decimal',
        value: assets.map(() => this.deprecationValue)
      },
      netValue: {
        type: 'decimal',
        value: assets.map(() => this.netValue)
      },
      economicInitialValue: {
        type: 'decimal',
        value: assets.map(() => this.economicInitialValue)
      },
      economicDeprecationValue: {
        type: 'decimal',
        value: assets.map(() => this.economicDeprecationValue)
      },
      economicNetValue: {
        type: 'decimal',
        value: assets.map(() => this.economicNetValue)
      },
      mergeInventoryNo: {
        type: 'string',
        value: assets.map(() => this.mergeInventoryNo)
      },
      mergeLineSymbol: {
        type: 'string',
        value: assets.map(() => this.mergeLineSymbol)
      },
      mergeType: {
        type: 'string',
        value: assets.map(() => this.mergeType)
      },
      buyerName: {
        type: 'string',
        value: assets.map(() => this.buyerName)
      },
      buyerAddress: {
        type: 'string',
        value: assets.map(() => this.buyerAddress)
      },
      saleValue: {
        type: 'decimal',
        value: assets.map(() => this.saleValue)
      }
    };
  };
