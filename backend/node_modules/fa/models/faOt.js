...
exports.setUp = (app, mongoose) =>
{
  ...
  schema.pre('save', function(next)
  {
    ...
    collectUsers(this, schema.statics.USER_PROPS, users);
    this.assets.forEach(asset => collectUsers(asset, schema.statics.USER_ASSET_PROPS, users));
  ...
  schema.methods.canEdit = function(user)
  {
    ...
    switch (this.stage)
    {
      ...
      case 'accept':
        return this.assets.some(a => !!a.owner && a.owner._id === user._id);
