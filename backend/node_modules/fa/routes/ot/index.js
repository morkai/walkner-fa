...
module.exports = (app, module) =>
{
  ...
  express.get('/fa/ot', canView, limitBrowse, browseRoute.bind(null, app, module));
  ...
  function limitBrowse(req, res, next)
  {
    ...
    if (!privileges.includes('SUPER') && !privileges.includes('FA:VIEW:FALL'))
    {
  ...
  {
    if (!canAccess(req.session.user, doc))
    {
