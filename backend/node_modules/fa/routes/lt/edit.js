...
module.exports = (app, module, req, res, next) =>
{
  ...
  step(
    function()
    {
      this.unlockEntry = locks.create(`${FaLt.TOPIC_PREFIX}.${req.params.id}`, this.next());
    },
    function()
    {
    ...
    function(err, unlockNoGenerator)
    {
      ...
      if (!this.doc.hrtFile && newStage === 'acceptDocument')
      {
        FaReqTpl.attach(this.doc, change, this.next());
      }
      else if (this.doc.hrtFile
        && oldStage === 'acceptDocument'
        && FaLt.STAGES.indexOf(newStage) < FaLt.STAGES.indexOf('acceptDocument'))
      {
