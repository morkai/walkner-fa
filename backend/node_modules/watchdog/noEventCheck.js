...
module.exports = (app, module) =>
{
  ...
  function callNoEvent(event, lastOccurrenceAt)
  {
    ...
    const callOptions = {
      ...
      text: `Missing event '${event.type}' for ${duration} hours.`
    };
    ...
    caller.call(callOptions, err =>
    {
      if (err)
      {
        module.error(err, `Failed to call.`, {eventId: event.id, recipients: [callOptions.to]});
      }
      else
      {
        module.info(`Called!`, {eventId: event.id, recipients: [callOptions.to]});
      }
