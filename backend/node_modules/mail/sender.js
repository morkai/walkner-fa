...
exports.start = (app, module) =>
{
  ...
  module.send = function(to, subject, text, done)
  {
    ...
    {
      mailOptions.from = module.config.overrideFrom === true
        ? module.config.from
        : module.config.overrideFrom;
    }
  ...
  function sendThroughFile(mailOptions, done)
  {
    ...
    step(
      function openFileStep()
      {
        ...
        const emailNo = NEXT_EMAIL_NO.toString().padStart(7, '0');
        const emailFileName = `${Date.now()}.${emailNo}.email`;
